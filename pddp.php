...
Plugin URI:        http://freewptp.com/plugins/publish-date-datepicker/
...
function pddp_settings_link( $links, $file ) {
	...
	if ( false !== strpos( $file, 'pddp' ) ) {
		$mylinks = array(
			'<a href="http://freewptp.com/forum/wordpress-plugins-forum/publish-date-datepicker-plugin/">' . esc_html__( 'Get Support', 'pddp' ) . '</a>'
		);
